TEXTS = {
    "tj": {
        ...
        "course_promo_caption": "📚 <b>Режими курс</b> ҳоло хомӯш аст.\n\nСаволҳои русиро дар режими савол-ҷавоб фиристед.",
    ...
    "ru": {
        ...
        "course_promo_caption": "📚 <b>Режим курса</b> сейчас отключён.\n\nОтправляйте вопросы по русскому в режиме вопрос-ответ.",
    ...
    "uz": {
        ...
        "course_promo_caption": "📚 <b>Kurs rejimi</b> hozir o‘chirilgan.\n\nRus tili bo‘yicha savollarni savol-javob rejimida yuboring.",
...
COURSE_I18N = {
    "tj": {
        "course_locked_title": "📚 Курс танҳо барои обуначиён",
        ...
        "course_mode_subscription_benefit": "Бо обуна имкониятҳои иловагӣ кушода мешаванд.",
        ...
        "help_section_text": (
            ...
            "— Дар бораи русӣ савол нависед: калима, ҷумла, грамматика, тарҷума ё мисол\n"
            ...
            "— Тарҷумон: voice-и русиро ба забони шумо, voice-и дигар забонро ба русии табиӣ тарҷума мекунад\n"
            "— Агар матн нависед, voice-режим худкор хомӯш мешавад\n\n"
            "📚 <b>Курс</b>\n"
            "— Режими курс ҳоло хомӯш аст\n"
            "— Барои омӯзиш калима, ҷумла ё саволи русиро ҳамчун паёми оддӣ фиристед\n\n"
            "💳 <b>Лимит ва обуна</b>\n"
            "— Бо дастрасии 24-соата саволу ҷавоб, фото ва voice дастрас мешавад\n"
        ...
        "voice_course_only": "🎙 Voice дар режими курс ҳоло дастрас нест. Саволро ҳамчун voice ё матни оддӣ фиристед.",
    ...
    "ru": {
        "course_locked_title": "📚 Курс только для подписчиков",
        ...
        "course_mode_subscription_benefit": "С подпиской также открываются дополнительные возможности.",
        ...
        "help_section_text": (
            ...
            "— Напишите вопрос по русскому: слово, фраза, грамматика, перевод или пример\n"
            ...
            "— Переводчик: русский voice переводит на ваш язык, voice на другом языке переводит на естественный русский\n"
            "— Если написать текст, voice-режим автоматически отключится\n\n"
            "📚 <b>Курс</b>\n"
            "— Режим курса сейчас отключён\n"
            "— Для обучения отправьте русское слово, фразу или вопрос обычным сообщением\n\n"
            "💳 <b>Лимиты и подписка</b>\n"
            "— При доступе на 24 часа открыты вопрос-ответ, фото и voice\n"
        ...
        "voice_course_only": "🎙 Voice в режиме курса сейчас недоступен. Отправьте вопрос voice или обычным текстом.",
    ...
    "uz": {
        "course_locked_title": "📚 Kurs faqat obunachilar uchun",
        ...
        "course_mode_subscription_benefit": "Obuna bilan qo‘shimcha imkoniyatlar ham ochiladi.",
        ...
        "help_section_text": (
            ...
            "— Rus tili bo‘yicha savol yozing: so‘z, gap, grammatika, tarjima yoki misol\n"
            ...
            "— Tarjimon: ruscha voice’ni sizning tilingizga, boshqa tildagi voice’ni tabiiy rus tiliga tarjima qiladi\n"
            "— Matn yozsangiz, voice rejimi avtomatik o‘chadi\n\n"
            "📚 <b>Kurs</b>\n"
            "— Kurs rejimi hozir o‘chirilgan\n"
            "— O‘rganish uchun ruscha so‘z, gap yoki savolni oddiy xabar qilib yuboring\n\n"
            "💳 <b>Limit va obuna</b>\n"
            "— 24 soatlik kirishda savol-javob, foto va voice ochiladi\n"
        ...
        "voice_course_only": "🎙 Kursdagi voice hozir ishlamaydi. Savolni voice yoki oddiy matn qilib yuboring.",
...
FEEDBACK_I18N = {
    "tj": {
        ...
        "feedback_like_course": "📚 Омӯзиш қулай аст",
        ...
        "feedback_dislike_pace": "📚 Суръати омӯзиш ноқулай аст",
    ...
    "ru": {
        ...
        "feedback_like_course": "📚 Удобное обучение",
        ...
        "feedback_dislike_pace": "📚 Темп обучения неудобен",
    ...
    "uz": {
        ...
        "feedback_like_course": "📚 O‘rganish qulay",
        ...
        "feedback_dislike_pace": "📚 O‘rganish tempi noqulay",
